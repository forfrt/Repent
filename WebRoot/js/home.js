...
$(document).ready(function(){
    function initToolbarBootstrapBindings() {
        var fonts = ['宋体', '微软雅黑', '仿宋','楷体', 'Arial', 'Courier', 'Courier New', 'Comic Sans MS', 'Impact'];
    ...
    //提交表单,先复制div内的内容到input.hiden然后再提交表单。
    $("#myform").bind("submit",function(){
        $("input.hiden")[0].value = $("#editor").html();
        this.submit();
    });
});
/*
...
function DisplayMoreArticles() {
    var aId,aTitle,aContent,uId,aTime,aBrCount,aReCount;
    ...
    for(var i=0;i<length;i++){
        ...
        var h6Str="<h6>"+aContent+"</h6>";
        var DetailsStr="<p class='btn btn-inverse offset6'><a href='#'>详细内容&gt;&gt;</a></p>";

        jQuery("#content>.well:last").after(divStr);
        jQuery("#content>.well:last").attr("id",aId);
        jQuery("#content>.well:last").append(h4Str);
        jQuery("#content>.well:last").append(h6Str);
        jQuery("#content>.well:last").append(DetailsStr);
    }
}
